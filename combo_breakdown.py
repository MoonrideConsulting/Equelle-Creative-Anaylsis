...
def filter_data(data, selected_messaging_theme, selected_creative_theme, selected_batch, start_date, end_date):
...
def main():
    ...
    # Step 2: Create filters for Messaging Theme, Creative Theme, Batch, and Date
    ...
    # Step 3: Filter the data based on selected criteria
    filtered_data = filter_data(data, selected_messaging_theme, selected_creative_theme, selected_batch, start_date, end_date)

    # Step 4: Group the data by Ad Name and aggregate the numeric columns
